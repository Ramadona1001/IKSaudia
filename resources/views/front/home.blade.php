            ...
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6" data-aos="fade-left">
                    <div class="about-content">
                        ...
                        <div class="about-mv">
                            <div class="about-mv-item mission">
                                <div class="about-mv-icon"><i class="bi bi-bullseye" aria-hidden="true"></i></div>
                                <div class="about-mv-title">{{ __('front.home.about.mission_title') }}</div>
                                <p class="about-mv-text">{{ __('front.home.about.mission_desc') }}</p>
                            </div>
                            <div class="about-mv-item vision">
                                <div class="about-mv-icon"><i class="bi bi-eye-fill" aria-hidden="true"></i></div>
                                <div class="about-mv-title">{{ __('front.home.about.vision_title') }}</div>
                                <p class="about-mv-text">{{ __('front.home.about.vision_desc') }}</p>
                            </div>
                        </div>
